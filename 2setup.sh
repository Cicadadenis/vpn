...
enter_server_address() {
  echo "Вы хотите, чтобы клиенты IKEv2 VPN подключались к этому серверу с использованием DNS-имени?,"
...
Клиент IKEv2 VPN "$client_name" экспортируется!
...
Следующие шаги: настройка клиентов IKEv2 VPN. Посмотреть:
